                    ...
                    <div className="flex items-center gap-2">
                        {(settings?.showVisa === "true") && (
                            <div className="bg-white rounded px-2 h-9 min-w-[3rem] flex items-center justify-center" title="Visa">
                                <svg viewBox="0 0 36 36" className="h-full w-auto max-w-full" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="#1A1F71" d="M14.683 23.869l2.274-14.15h3.655l-2.274 14.15h-3.655zm10.652-13.805c-1.261-.643-2.472-.967-3.5-0.967-3.868 0-6.588 2.019-6.607 4.909-.019 2.134 1.945 3.32 3.429 4.028 1.519.726 2.033 1.196 2.033 1.838 0 .991-1.209 1.442-2.327 1.442-1.554 0-2.378-.247-3.647-.811l-.508-.239-.539 3.311c1.026.467 2.923.874 4.888.874 4.596 0 7.585-2.227 7.608-5.676.011-1.892-1.151-3.33-3.674-4.512-1.53-.733-2.472-1.237-2.472-1.996-.006-.701.785-1.422 2.493-1.422 1.411 0 2.441.298 3.203.666l.391.198.541-4.755-.262-.12v-.006zm4.318-.339h-2.821c-.876 0-1.53.253-1.911 1.159l-5.43 12.565h3.848l.766-2.11h4.685l.443 2.11h3.39l-2.97-13.724zm-4.234 9.584l1.751-4.79.999 4.79h-2.75zm-14.542-9.245h-3.797l-.042.204c-.927 4.798-3.892 11.189-7.054 13.48l1.03 1.302c4.766-1.242 9.605-6.035 10.864-12.645l1.861 8.863 4.124-.323-.186-.883-6.8-10.002z" />
                                </svg>
                            </div>
                        )}
