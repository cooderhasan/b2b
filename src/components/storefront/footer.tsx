                    ...
                    <div className="flex items-center gap-2">
                        {(settings?.showVisa === "true") && (
                            <div className="bg-white rounded px-2 h-9 min-w-[3rem] flex items-center justify-center" title="Visa">
                                <svg viewBox="0 0 32 32" className="h-full w-auto max-w-full" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="#1434CB" d="M12.796 23.952l1.983-11.968h3.187l-1.983 11.968h-3.187zM22.083 12.28c-1.1-.56-2.155-.843-3.053-.843-3.371 0-5.744 1.76-5.76 4.281-.017 1.861 1.696 2.895 2.99 3.513 1.325.632 1.772 1.042 1.772 1.603 0 .866-1.054 1.258-2.03 1.258-1.354 0-2.074-.216-3.18-.707l-.442-.208-.47 2.887a9.38 9.38 0 0 0 3.394.636c3.197 0 5.866-1.543 5.887-3.935.016-1.312-.79-2.296-2.522-3.111-1.05-.532-1.693-.895-1.693-1.442-.016-.499.569-1.008 1.815-1.008 1.488 0 2.551.343 3.332.697l.406.182.264-4.234v.43zm3.765-.296h-2.46c-.761 0-1.334.22-1.666 1.01l-4.735 10.957h3.355l.668-1.84h4.085l.386 1.84h2.956l-2.589-11.967zm-3.692 8.358l1.527-4.177.873 4.177h-2.4zM9.497 12.001H6.187L6.15 12.18c-.808 4.184-3.393 9.756-6.15 11.755l.898 1.135c4.156-1.083 8.373-5.263 9.471-11.025l1.623 7.728 3.596-.282-.162-.77-5.929-28.72z" />
                                </svg>
                            </div>
                        )}
