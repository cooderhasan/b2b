                    ...
                    <div className="flex items-center gap-2">
                        {(settings?.showVisa === "true") && (
                            <div className="bg-white rounded px-2 h-9 min-w-[3rem] flex items-center justify-center p-1" title="Visa">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 16" className="h-full w-auto">
                                    <path fill="#1A1F71" d="M19.9,12.3L22.6,2.4h3.6l-3.8,9.9H19.9z M13.2,12.3l-2-7.8l-0.8,7.8H13.2z M17.9,2.4 h3.1l-1.9,9.9h-3.4l2.8-6.6L17.9,2.4z M32.6,5.3c0.1-1.1,1.1-1.8,2.3-1.8c0.6,0,1.4,0.1,1.9,0.3l0.4-1.9C36.6,1.7,35.6,1.5,34.4,1.5 c-2.7,0-4.6,1.4-4.6,3.4c0,3.3,4.9,3.5,4.9,5.2c0,0.5-0.6,0.9-1.5,0.9c-1.1,0-2.3-0.2-3-0.5l-0.5,2.1c0.7,0.3,2,0.6,3.4,0.6 c2.8,0,4.7-1.4,4.7-3.6C37.8,4.5,32.6,4.2,32.6,2.7C32.6,2.2,33.1,2,33.5,2c0.2,0,1,0.1,1.5,0.3L34.7,4C34.1,3.8,33.4,3.7,32.8,3.7 C32.4,3.7,32.2,3.8,32.2,4.1C32.2,4.3,32.4,4.4,32.6,4.5L32.6,5.3z M8.9,2.4H5c-0.6,0-1.1,0.2-1.3,0.8L0,12.3h3.9l0.8-2.6 h4.3l0.4,2.6h3.6L8.9,2.4z M6.4,7.8l0.9-2.9l0.8,2.9H6.4z M42.4,12.3l2.2-9.9h3.6l-2.6,9.9H42.4z" />
                                </svg>
                            </div>
                        )}
