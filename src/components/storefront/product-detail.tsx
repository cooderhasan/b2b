                    ...
                    {isDealer && product.stock > 0 && (
                        <div className="space-y-4 pt-4 border-t">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Link href={`/request-quote?product=${product.id}&quantity=${quantity}`} className="flex-1">
                                    <Button size="lg" variant="outline" className="w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white">
